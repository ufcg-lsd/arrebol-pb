...
```
#### 1.4 - Adds a new node to a given queue
| Method | URI |
| :--- | :--- |
| `POST` | `/api/queues/{queue_id}/nodes` |
...
#### 1.5 - Retrieves all nodes of a given queue
| Method | URI |
| :--- | :--- |
| `GET` | `/api/queues/{queue_id}/nodes` |
...
| Method | URI |
| :--- | :--- |
| `DELETE` | `/api/queues/{queue_id}/nodes/{node_id}` |
